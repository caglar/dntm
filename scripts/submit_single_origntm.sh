...
THEANO_FLAGS=device=gpu,floatX=float32,force_device=True,lib.cnmem=0.85 python ${CODE_ROOT}/submit_single_origmodel_nodb.py --task_id $1 --reload_model $2 --save_path $3
